...
# SAFETY NOTE: Upstream budget_calc uses unsafe dynamic code execution (eval) on external distance-matrix data. That function was NOT copied verbatim. If reimplemented, parse cost safely with float conversion instead.
